...
<footer class="row panel panel-default">
  <div class="panel-body">
    ...
    <a href="http://da2i.univ-lille1.fr/" class="pull-right"><img src=${pageContext.request.contextPath}/${pageContext.servletContext.getInitParameter("logoDa2i")} alt="Logo GitHub" class="pull-right img-rounded md-hidden"/></a>
  </div>
</footer>
